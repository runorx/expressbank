      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
          ...
          <blockquote className="mt-10">
            <div className="max-w-3xl mx-auto text-center text-xl sm:text-2xl leading-9 font-medium text-gray-900">
              <p>
                &ldquo;Express Bank has revolutionized the way I manage my finances. Their mobile app is intuitive, and their customer service is top-notch. I couldn't be happier with my banking experience.&rdquo;
              </p>
            </div>
            <footer className="mt-8">
              <div className="md:flex md:items-center md:justify-center">
                ...
                <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                  ...
                  <svg className="hidden md:block mx-1 h-5 w-5 text-navy-blue" fill="currentColor" viewBox="0 0 20 20">
